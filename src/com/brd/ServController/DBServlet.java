	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(button.equals("maker")){
			if(operation.equals("add")){
				...
				getServletContext().getRequestDispatcher("/WEB-INF/cust_code.jsp").forward(request, response);
			}
			...
			if(operation.equals("viewChecker")){
				...
				getServletContext().getRequestDispatcher("/WEB-INF/checker/checker_cust_code.jsp").forward(request, response);
			}
