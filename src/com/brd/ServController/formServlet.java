...
public class formServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(button.equals("Back to Select C")){
			getServletContext().getRequestDispatcher("/WEB-INF/checker/checker_select.html").forward(request, response);
		}
		else if(button.equals("Back to Select M")){
			getServletContext().getRequestDispatcher("/WEB-INF/maker/maker_select.html").forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//HttpSession session = request.getSession(false);
		//String operation = (String)session.getAttribute("operation2");	
		...
		String strRet = null;
			...
			else if(button.equals("modify_master")){
				String custCode = request.getParameter("custCode");
			...
			else if(button.equals("maker_searchall")){
			...
			else if(button.equals("viewCheckerSpecific")){
				String custCode = request.getParameter("custCode");
				cus = sl.setVarsCust2(custCode);
			...
			else if(button.equals("viewChecker")){				
